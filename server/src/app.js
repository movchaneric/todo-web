...
app.use(flash());//flashing messages

app.use(bodyParser.urlencoded({ extended: false })) //Body-Parser
app.use(multer({ storage: multerCnfg.fileStorage, fileFilter: multerCnfg.imageFilter }).single('image')) // to parse files such as images
